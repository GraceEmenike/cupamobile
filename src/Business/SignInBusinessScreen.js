...
export default function App({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <View>
        <Text style={styles.signInInstruction}>Create your by business entering your business name and password for authentication</Text>
      </View>
      <View>
      ...
      <TouchableOpacity
        onPress={() => { navigation.navigate("BuisinessApp"); console.log("I will sign in a business"); }}>
        <View>
          <Text style={styles.signButton}>Sign In</Text>
        </View>
      </TouchableOpacity>
      <TouchableOpacity
        onPress={() => { navigation.navigate("BusinessRegisterScreen"); }}>
        <View>
          <Text style={styles.signButton}>New to Cupa? Register your Business</Text>
        </View>
      </TouchableOpacity>
